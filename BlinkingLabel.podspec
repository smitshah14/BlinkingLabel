...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "Description of the CocoaPod" <<-DESC
                       DESC

  s.homepage         = "https://github.com/smitshah14/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "SMIT V SHAH" => "smit.shah@ahold.com" }
  s.source           = { :git => "https://github.com/smitshah14/BlinkingLabel", :tag => s.version.to_s }
